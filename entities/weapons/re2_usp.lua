...
SWEP.ViewModelBoneMods = {
	["v_weapon.USP_Trigger"] = { scale = Vector(0.009, 0.009, 0.009), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) },
	["v_weapon.USP_Hammer"] = { scale = Vector(0.009, 0.009, 0.009), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) },
	["v_weapon.USP_Switch"] = { scale = Vector(0.009, 0.009, 0.009), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) },
	["v_weapon.USP_Release"] = { scale = Vector(0.009, 0.009, 0.009), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) },
	["v_weapon.USP_Silencer"] = { scale = Vector(0.009, 0.009, 0.009), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) },
	["v_weapon.USP_Slide"] = { scale = Vector(0.009, 0.009, 0.009), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) }
}
...
SWEP.VElements = {
	["usp"] = { type = "Model", model = "models/props/re2_remake_mup.mdl", bone = "v_weapon.USP_Parent", rel = "", pos = Vector(-0.218, -0.866, 1.796), angle = Angle(-89.74, -0.299, -87.814), size = Vector(0.999, 0.999, 0.999), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
...
SWEP.WElements = {
	["usp"] = { type = "Model", model = "models/props/re2_remake_mup.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.405, 0.814, -1.073), angle = Angle(-3.662, 5.386, 170.934), size = Vector(0.796, 0.796, 0.796), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

--------------------------------

SWEP.IronSightsPos = Vector(-5.901, -5.032, 2.917)
SWEP.IronSightsAng = Vector(-0.524, 0.231, -2.566)
...
SWEP.PrintName = "#re2gm_wpn_9mm"                        
SWEP.Author = "@CuttaChaseBeats" 
SWEP.Purpose = "#re2gm_wpn_9mm_purpose"         
SWEP.Instructions = "#re2gm_wpn_9mm_inst"              
...
SWEP.Primary.Sound = "weapons/usp/9mm_unsil-1.wav"
...
function SWEP:PrimaryAttack()
	...
	self.Weapon:EmitSound(self.Primary.Sound, 110, 100, 0.1)
