...
SWEP.ViewModel = "models/weapons/v_shor_m3super90.mdl"      
...
SWEP.VElements = {
	["primer"] = { type = "Model", model = "models/props_junk/propane_tank001a.mdl", bone = "shell", rel = "bullet", pos = Vector(0, 0, 0.15), angle = Angle(0, 0, 0), size = Vector(0.019, 0.019, 0.009), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} },
	["bullet"] = { type = "Model", model = "models/props_c17/oildrum001.mdl", bone = "shell", rel = "", pos = Vector(0, -0.75, 0.5), angle = Angle(0, 0, 90), size = Vector(0.012, 0.012, 0.02), color = Color(255, 255, 127, 255), surpresslightning = false, material = "grey", skin = 0, bodygroup = {} }
}
...
SWEP.HoldType = "ar2"                            
SWEP.PrintName = "Winchester 1873 Carbine"                        
...
SWEP.IronSightsPos = Vector(4.369, 0, 2.5)
...
//Primary Attributes
--------------------------
SWEP.Primary.Sound = "weapons_1873/m3-1.wav"        
...
SWEP.Primary.EffectiveRange = 900                       
SWEP.Primary.NumberofShots = 1                  
SWEP.Primary.Automatic = false
SWEP.Primary.Delay = 1.2                         
SWEP.Primary.Force = 1                     
SWEP.Primary.KickUp = 0.7                      
SWEP.Primary.KickSides = 0.5
...
if self.Weapon:GetNetworkedBool("VBEnabled") then
		...
		if CLIENT then
		self.Weapon:PrintMessage(HUD_PRINTTALK, "View bobbing is now enabled")
		end
	end
...
function SWEP:OnFire()
	...
	// Muzzle effects
		...
		local muzzledata = EffectData{}
			...
			muzzledata:SetAngles(self.Weapon:GetAttachment(muzzleattachment).Ang + Angle(0,0,0))
	...
	timer.Simple (0.6, function()
		...
		local shelldata = EffectData{}
			...
			shelldata:SetAngles((self.Weapon:GetAttachment(ejectattachment).Ang) + Angle(40,180,0))
		...
		util.Effect("ShellEject", shelldata)
		end)
end
	...
	if ( self.Weapon:GetNetworkedBool( "reloading", true ) ) then
		...
		if ( self.Weapon:GetVar( "reloadtimer", 0 ) < CurTime() ) then
			...
			timer.Simple(0.1, function() 
				self.Owner:EmitSound(Sound("weapons/shotgun/shotgun_reload2.wav"))
			end)
