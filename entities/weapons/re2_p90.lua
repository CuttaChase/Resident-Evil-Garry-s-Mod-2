...
SWEP.WorldModel = "models/weapons/w_smg_pre.mdl"
SWEP.ShowViewModel = true
SWEP.ShowWorldModel = false
SWEP.ViewModelBoneMods = {}

----------------------
SWEP.IronSightsPos = Vector(3.079, 0, -0.16)
...
SWEP.WElements = {
	["p90"] = { type = "Model", model = "models/weapons/w_smg_pre.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-2.314, -0.195, 0.888), angle = Angle(-3.507, -8.183, 180), size = Vector(1.08, 1.08, 1.08), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
...
SWEP.PrintName = "#re2gm_wpn_p90"                        
SWEP.Author = "@CuttaChaseBeats" 
SWEP.Purpose = "#re2gm_wpn_p90_purpose"         
SWEP.Instructions = "#re2gm_wpn_p90_inst"              
