...
SWEP.ViewModel = "models/weapons/v_1897_m3super90.mdl"      
...
SWEP.PrintName = "Winchester M1897 'Trench Gun'"                        
...
SWEP.IronSightsPos = Vector(-3.401, -1, 2)
...
//Primary Attributes
--------------------------
SWEP.Primary.Sound = "weapons_1897/m3-1.wav"        
...
SWEP.Primary.EffectiveRange = 500                       
...
function SWEP:PrimaryAttack()
	...
	local bullet = {}
		bullet.Num = self.Primary.NumberofShots + 9
...
function SWEP:OnFire()
	...
	// Muzzle effects
		...
		local muzzledata = EffectData{}
			...
			muzzledata:SetAngles(self.Weapon:GetAttachment(muzzleattachment).Ang + Angle(0,90,0))
	...
	timer.Simple (0.6, function()
		...
		local shelldata = EffectData{}
			...
			shelldata:SetAngles((self.Weapon:GetAttachment(ejectattachment).Ang) + Angle(0,0,0))
		...
		util.Effect("ShotgunShellEject", shelldata)
		end)
end
