...
-------------------
SWEP.HoldType = "smg"
SWEP.ViewModelFOV = 70.954773869347
...
SWEP.ViewModelBoneMods = {
	["ValveBiped.Bip01_R_Clavicle"] = { scale = Vector(1, 1, 1), pos = Vector(-3.142, 0, 0), angle = Angle(0, 0, 0) },
	["ValveBiped.base"] = { scale = Vector(0.009, 0.009, 0.009), pos = Vector(2.7, 0, 0), angle = Angle(0, 0, 0) },
	["ValveBiped.Bip01_L_Clavicle"] = { scale = Vector(1, 1, 1), pos = Vector(-4.571, -0.652, -0.079), angle = Angle(0, 2.867, 0) }
}
...
SWEP.VElements = {
	["mp5"] = { type = "Model", model = "models/props/re2_remake_le_5.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.628, 1.281, -0.21), angle = Angle(1.169, -15.195, -180), size = Vector(1.195, 1.195, 1.195), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
...
SWEP.WElements = {
	["mp5"] = { type = "Model", model = "models/props/re2_remake_le_5.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2.609, 1.292, -0.229), angle = Angle(-8.292, -4.476, 180), size = Vector(0.912, 0.912, 0.912), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

--------------------------------

SWEP.IronSightsPos = Vector(-7.801, 0, 1.679)
SWEP.IronSightsAng = Vector(-2.814, -4.987, 3.517)
...
SWEP.PrintName = "#re2gm_wpn_mp5"                        
SWEP.Author = "@CuttaChaseBeats" 
SWEP.Purpose = "#re2gm_wpn_mp5_purpose"         
SWEP.Instructions = "#re2gm_wpn_mp5_inst"              
...
SWEP.Primary.Sound = "weapons/p220/p228-1.wav"
