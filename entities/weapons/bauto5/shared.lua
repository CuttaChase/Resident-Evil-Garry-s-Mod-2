...
SWEP.ViewModel = "models/weapons/v_auto_xm1014.mdl"      
...
SWEP.IronSightsPos = Vector(1.95, -0.601, 1.399)
...
//Primary Attributes
--------------------------
SWEP.Primary.Sound = "weapons_auto/xm1014-1.wav"        
...
function SWEP:OnFire()
	...
	// Shell eject
		...
		local shelldata = EffectData{}
			...
			shelldata:SetAngles((self.Weapon:GetAttachment(ejectattachment).Ang) + Angle(180,0,0))
...
function SWEP:Think()
	...
	if ( self.Weapon:GetNetworkedBool( "reloading", true ) ) then
		...
		if ( self.Weapon:GetVar( "reloadtimer", 0 ) < CurTime() ) then
			...
			//self.Owner:EmitSound(Sound("weapons_auto/xm1014_insertshell.wav"))
