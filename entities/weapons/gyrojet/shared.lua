...
SWEP.ViewModel = "models/weapons/v_gyro_deagle.mdl"      
...
SWEP.PrintName = "MBA Gyrojet Mk.1"                        
...
SWEP.IronSightsPos = Vector(4.679, -2, 2.769)
...
//Primary Attributes
--------------------------
SWEP.Primary.Sound = "weapons_gyro/deagle-1.wav"        
...
SWEP.Primary.EffectiveRange = 1200                       
SWEP.Primary.NumberofShots = 1                  
SWEP.Primary.Automatic = false
SWEP.Primary.Delay = 0.12                         
SWEP.Primary.Force = 0                     
SWEP.Primary.KickUp = 0.25                      
SWEP.Primary.KickSides = 0.25
...
function SWEP:OnFire()
	...
	/*// Muzzle effects
		...
		local muzzledata = EffectData{}
			...
			muzzledata:SetAngles(self.Weapon:GetAttachment(muzzleattachment).Ang + Angle(90,0,0))
	...
	// Shell eject
		...
		local shelldata = EffectData{}
			...
			shelldata:SetAngles((self.Weapon:GetAttachment(ejectattachment).Ang) + Angle(0,180,0))
