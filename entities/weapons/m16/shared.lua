...
SWEP.IronSightsPos = Vector(2.539, -2.412, 0.439)
...
//Primary Attributes
--------------------------
SWEP.Primary.Sound = "weapons_m16/famas-1.wav"        
...
// Adjust the player's aim
	...
	// Shell eject
		...
		local shelldata = EffectData{}
			...
			shelldata:SetAngles((self.Weapon:GetAttachment(ejectattachment).Ang) + Angle(180,10,0) )
