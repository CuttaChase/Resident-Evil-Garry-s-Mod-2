...
SWEP.ViewModel = "models/weapons/v_fnc_galil.mdl"      
...
SWEP.IronSightsPos = Vector(-2.425, -0.403, 0.62)
...
//Primary Attributes
--------------------------
SWEP.Primary.Sound = "weapons_fnc/galil-1.wav"        
...
// Adjust the player's aim
	...
	// Shell eject
		...
		local shelldata = EffectData{}
			...
			shelldata:SetAngles((self.Weapon:GetAttachment(ejectattachment).Ang) + Angle(50,0,0) )
