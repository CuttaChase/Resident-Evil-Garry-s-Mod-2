...
SWEP.ViewModel = "models/weapons/v_mach_m249rpk7.mdl"      
...
SWEP.IronSightsPos = Vector(-1.67, 0, 0.889)
...
//Primary Attributes
--------------------------
SWEP.Primary.Sound = "weapons_rpk/rpk-1.wav"        
...
SWEP.Primary.EffectiveRange = 1000                       
...
function SWEP:Initialize()
	...
	if CLIENT then
		...
		if IsValid(self.Owner) then
			...
			local vm = self.Owner:GetViewModel() or 0
			if IsValid(vm) then
...
// Adjust the player's aim
	...
	// Shell eject
		...
		local shelldata = EffectData{}
			...
			shelldata:SetAngles(self.Weapon:GetAttachment(ejectattachment).Ang + Angle(30,-30,0))
