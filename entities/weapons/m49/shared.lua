...
SWEP.ViewModel = "models/weapons/v_smg_m49.mdl"      
...
SWEP.IronSightsPos = Vector(-1.961, -0.403, 0.959)
...
//Primary Attributes
--------------------------
SWEP.Primary.Sound = "weapons_m49/p90-1.wav"        
...
// Adjust the player's aim
	...
	// Shell eject
		...
		local shelldata = EffectData{}
			...
			shelldata:SetAngles(self.Weapon:GetAttachment(ejectattachment).Ang + Angle(-20,10,0))
