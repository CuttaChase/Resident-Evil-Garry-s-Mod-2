...
SWEP.ViewModel = "models/weapons/v_shet_m3super90.mdl"      
...
SWEP.IronSightsPos = Vector(4.449, -2.814, 2.65)
...
//Primary Attributes
--------------------------
SWEP.Primary.Sound = "weapons_r870/m3-1.wav"        
...
function SWEP:OnFire()
	...
	// Muzzle effects
		...
		local muzzledata = EffectData{}
			...
			muzzledata:SetAngles(self.Weapon:GetAttachment(muzzleattachment).Ang + Angle(0,180,90))
