...
SWEP.ViewModel = "models/weapons/v_pist_mk22.mdl"      
...
SWEP.VElements = {
["suppressor"] = { type = "Model", model = "models/mechanics/wheels/wheel_speed_72.mdl", bone = "Frame", rel = "", pos = Vector(-0.051, 5.8, 2), angle = Angle(0, 0, 90), size = Vector(0.017, 0.017, 0.3), color = Color(50, 50, 50, 255), surpresslightning = false, material = "metal6", skin = 0, bodygroup = {} }
}
...
SWEP.PrintName = "S&W MK22 'Hush Puppy'"                        
...
SWEP.IronSightsPos = Vector(1.769, 0, 0.75)
...
//Primary Attributes
--------------------------
SWEP.Primary.Sound = "weapons_mk22/mp5-2.wav"        
...
SWEP.Primary.EffectiveRange = 700                       
SWEP.Primary.NumberofShots = 1                  
SWEP.Primary.Automatic = false
SWEP.Primary.Delay = 0.13                         
SWEP.Primary.Force = 10                     
SWEP.Primary.KickUp = 0.5                      
SWEP.Primary.KickSides = 0.3
...
function SWEP:OnFire()
	...
	// Shell eject
		...
		local shelldata = EffectData{}
			...
			shelldata:SetAngles((self.Weapon:GetAttachment(ejectattachment).Ang) + Angle(-90,0,0))
