...
SWEP.ViewModel = "models/weapons/v_smg_mp4.mdl"      
...
SWEP.IronSightsPos = Vector(-1.871, -0.603, 0.92)
...
//Primary Attributes
--------------------------
SWEP.Primary.Sound = "weapons_mp40/mp40-1.wav"        
...
// Adjust the player's aim
	...
	// Shell eject
		...
		local shelldata = EffectData{}
			...
			shelldata:SetAngles(self.Weapon:GetAttachment(ejectattachment).Ang + Angle(30,0,0))
