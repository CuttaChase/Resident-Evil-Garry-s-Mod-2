...
SWEP.ViewModel = "models/weapons/v_smg_thomp.mdl"      
...
SWEP.IronSightsPos = Vector(-3.481, -2.211, 2.079)
...
//Primary Attributes
--------------------------
SWEP.Primary.Sound = "weapons_thompson/1.wav"        
