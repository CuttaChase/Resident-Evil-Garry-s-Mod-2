...
SWEP.ViewModel = "models/weapons/v_magh_m249para.mdl"      
SWEP.WorldModel = "models/weapons/w_irifle.mdl" --"models/weapons/w_mach_m249para.mdl"
...
SWEP.IronSightsPos = Vector(-5.401, -3.418, 2.15)
...
//Primary Attributes
--------------------------
SWEP.Primary.Sound = "weapons_m60/m249-1.wav"        
...
SWEP.Primary.EffectiveRange = 1350                       
SWEP.Primary.NumberofShots = 1                  
SWEP.Primary.Automatic = true
SWEP.Primary.Delay = 0.1                         
SWEP.Primary.Force = 5                     
SWEP.Primary.KickUp = 0.3                     
SWEP.Primary.KickSides = 0.4
	...
	// Shell eject
		...
		local shelldata = EffectData{}
			...
			if self.Owner:KeyDown(IN_DUCK) then
				...
				shelldata:SetOrigin(self.Weapon:GetAttachment(ejectattachment).Pos + Vector(0,0,63))
			end
