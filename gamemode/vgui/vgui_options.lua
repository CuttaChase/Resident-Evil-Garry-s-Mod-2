...
function MENU:OptionsMenu()
	...
	self.Options.Paint = function( pan, ww, hh )
		...
		MENU:EndStencil()
		draw.SimpleTextOutlined( "Options", "wOS.GenericLarge", ww/2, hh*0.1, color_white, TEXT_ALIGN_CENTER, TEXT_ALIGN_BOTTOM, 0, color_white )
	...
	OptionsContent.Paint = function( pan, ww, hh )
		...
		draw.SimpleTextOutlined( "Enable Content Messages", "wOS.GenericMed", ww*0.28, hh/2, color_white, TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER, 0, color_white )		
	...
	OptionsMusic.Paint = function( pan, ww, hh )
		...
		draw.SimpleTextOutlined( "Enable Music", "wOS.GenericMed", ww*0.28, hh/2, color_white, TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER, 0, color_white )		
	end
	...
	crp.Paint = function( pan, ww, hh )
		...
		draw.SimpleTextOutlined( "Laser Color", "wOS.GenericMed", ww/2, hh*0.2, color_white, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 0, color_white )
