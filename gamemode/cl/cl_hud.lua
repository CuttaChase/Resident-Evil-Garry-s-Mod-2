...
function GM:HUDPaint()
	...
	----------------Ammo
			...
			paintText(translate.Format("ammo_x_format", intAmmoOutMag),"Trebuchet18o",5,97,Color(200,200,200,255),false,false)
			--..
			paintText(translate.Format("kills_x_format", client:GetNWInt("killcount")),"Trebuchet18o",5,72,Color(200,200,200,255),false,false)
			paintText(translate.Format("money_x_format2", string.Comma(Money)), "Trebuchet24o", 20, 0, Color(0,255,0,255), false, false)
