...
ITEM.ClassName = "weapon_mp5"
ITEM.WeaponClass = "re2_mp5"

ITEM.Name = "MP5"
ITEM.Desc = "MP5"
ITEM.Model = "models/props/re2_remake_le_5.mdl"
...
ITEM.Upgrades[ "power" ] = {
	...
	GetNew = function( level ) return ( 6 + 0.6*level ) end,
...
ITEM.Upgrades[ "capacity" ] = {
	...
	GetNew = function( level ) return ( 19 + 1*level ) end,
