...
ITEM.Upgrades[ "power" ] = {
	...
	GetCost = function( level ) return ( 500 + level*600 ) end,
	
	GetNew = function( level ) return ( 8 + 0.5*level ) end,
...
ITEM.Upgrades[ "precision" ] = {
	...
	GetCost = function( level ) return ( 100 + level*300 ) end,
	
	GetNew = function( level ) return ( 0.5 - 0.005*level ) end,
...
ITEM.Upgrades[ "capacity" ] = {
	...
	GetCost = function( level ) return ( 300 + level*200 ) end,
