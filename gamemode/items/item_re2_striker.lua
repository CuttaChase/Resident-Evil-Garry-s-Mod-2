...
ITEM.ClassName = "weapon_striker"
ITEM.WeaponClass = "re2_striker"
...
ITEM.Upgrades[ "power" ] = {
	...
	GetNew = function( level ) return ( 13 + 2*level ) end,
...
ITEM.Upgrades[ "precision" ] = {
	...
	GetCost = function( level ) return ( 100 + level*500 ) end,
	
	GetNew = function( level ) return ( 0.7 - 0.008*level ) end,
