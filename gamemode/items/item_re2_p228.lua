...
ITEM.ClassName = "weapon_p228"
ITEM.WeaponClass = "re2_p228"

ITEM.Name = "P228"
ITEM.Desc = "P228"
ITEM.Model = "models/weapons/w_pist_p220.mdl"
...
ITEM.Upgrades[ "power" ] = {
	...
	GetNew = function( level ) return ( 14 + 1.1*level ) end,
...
ITEM.Upgrades[ "capacity" ] = {
	...
	GetNew = function( level ) return ( 7 + 1*level ) end,
...
ITEM.Upgrades[ "chambering" ] = {
	...
	GetNew = function( level ) return ( 0.34 - 0.005*level ) end,
