...
ITEM.ClassName = "weapon_ak47"
ITEM.WeaponClass = "re2_ak47"
...
ITEM.Upgrades[ "power" ] = {
	...
	GetNew = function( level ) return ( 15 + 0.8*level ) end,
...
ITEM.Upgrades[ "precision" ] = {
	...
	GetNew = function( level ) return ( 0.42 - 0.01*level ) end,
...
ITEM.Upgrades[ "capacity" ] = {
	...
	GetNew = function( level ) return ( 21 + 1*level ) end,
...
ITEM.Upgrades[ "chambering" ] = {
	...
	GetNew = function( level ) return ( 0.27 - 0.005*level ) end,
