...
ITEM.ClassName = "weapon_p90"
ITEM.WeaponClass = "re2_p90"
...
ITEM.Upgrades[ "power" ] = {
	...
	GetCost = function( level ) return ( 500 + level*800 ) end,
	
	GetNew = function( level ) return ( 8 + 0.7*level ) end,
...
ITEM.Upgrades[ "precision" ] = {
	...
	GetCost = function( level ) return ( 100 + level*600 ) end,
	
	GetNew = function( level ) return ( 0.55 - 0.004*level ) end,
...
ITEM.Upgrades[ "capacity" ] = {
	...
	GetCost = function( level ) return ( 300 + level*600 ) end,
...
ITEM.Upgrades[ "chambering" ] = {
	...
	GetNew = function( level ) return ( 0.14 - 0.004*level ) end,
