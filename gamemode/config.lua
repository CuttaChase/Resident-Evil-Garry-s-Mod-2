...
itemtypes = {
	...
	["item_decoy"] = "DecoyBomb",
	["item_crate"] = "Crate",
	["item_rammo"] = "RifleAmmo",
	["item_pammo"] = "PistolAmmo",
	["item_gherb"] = "GreenHerb",
	["item_bherb"] = "BlueHerb",
	["item_rherb"] = "RedHerb",
	["item_money"] = "Money",
	["item_tcure"] = "TVirusCure",
	["item_spray"] = "HealthSpray",
	["item_mammo"] = "SMGAmmo",
	["item_3ammo"] = "MagnumAmmo",
	["item_bammo"] = "ShotgunAmmo",
	["item_mixedherb1"] = "GRHerb",
	["item_mixedherb2"] = "RGBHerb",
	["item_mixedherb3"] = "GGHerb",
	["item_mixedherb4"] = "GGGHerb",
	["item_barricade"] = "Barricade",
}
weapontypes = {
	["weapon_ak47"]="AK47",
	["weapon_deagle"]="Deagle",
	["weapon_glauncher"]="GrenadeLauncher",
	["weapon_minigun"]="Minigun",
	["weapon_mp5"]="MP5",
	["weapon_p90"]="P90",
	["weapon_pumpshot"]="PumpShotgun",
	["weapon_quadrpg"]="RocketLauncher",
	["weapon_striker"]="Striker7",
	["weapon_usp"]="USP",
	["weapon_ragerev"]="RagingRevolver",
	["weapon_spas12"]="Spas12",
	["weapon_m4"]="ColtM4A1Carbine",
	["weapon_glock18"]="Glock18",
	["weapon_p228"]="SauerP228",
	["weapon_ump"]="UMP45",
}

zombtable = {
	["snpc_shambler"] = "Shambler",
	["snpc_shambler_fast"] = "FastShambler",
 	["snpc_zombie_dog"] = "ZombieDog",
...
GM.Gamemode = {}
		...
		RewardFunction = function()
				if table.Count(team.GetPlayers(TEAM_HUNK)) == 1 then
					if table.Count(team.GetPlayers(TEAM_HUNK)) > 0 then
						...
						PrintTranslatedMessage( HUD_PRINTTALK, "last_person_alive_won_x_reward", reward )
						for _,ply in pairs(player.GetAll()) do
							Save(ply)
							if ply:Team() == TEAM_HUNK then
	...
	GM.Gamemode["Boss"] = {
		...
		GM.Gamemode["Doom"] = {
			...
			StartFunction = function()
								...
								SetGlobalInt("DeadZombieKillNumber", GetGlobalInt("DeadZombieKillNumber") + modifier)
								PrintTranslatedMessage(HUD_PRINTTALK, "kill_enough_zombies_to_win" )
								local Zombie = {
									"snpc_zombie_nemesis",
								}
	...
	GM.Gamemode["Escape"] = {
		...
		RewardFunction = function()
				...
				reward = reward * GAMEMODE.ZombieData[GetGlobalString("Re2_Difficulty")].Modifier
				PrintTranslatedMessage( HUD_PRINTTALK, "escaped_won_x_reward", reward )
				if team.NumPlayers(TEAM_HUNK) > 1 then
					...
					PrintTranslatedMessage( HUD_PRINTTALK, "survivors_survived_x_reward", team.NumPlayers(TEAM_HUNK), #player.GetAll(), additionalreward )
				end
				for _,ply in pairs(player.GetAll()) do
					Save(ply)
					if ply:Team() == TEAM_HUNK then
	...
	GM.Gamemode["TeamVIP"] = {
		...
		RewardFunction = function()
			...
			PrintTranslatedMessage( HUD_PRINTTALK, "teamvip_won", GetGlobalString("Re2_TEAMVIP_Winner"), reward )
		end,
